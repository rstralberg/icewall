...
function editThemeApp(content) {
    ...
    document.getElementById(EDIT_THEMES_BG).value = get_style('bg' + part);
    document.getElementById(EDIT_THEMES_FG).value = get_style('fg' + part);
    selectOption(document.getElementById(EDIT_THEMES_FONT), get_style('font'));
...
function editThemeContent(content) {
        ...
        (resolve) => {
            if (resolve.status === 'ok') {
                ...
                switch (part) {
                    ...
                    // case 'navbar': editThemeNavbar(resolve.content); break;
                    // case 'title': editThemeTitle(resolve.content); break;
                    // case 'content': editThemeContent(resolve.content); break;
                    // case 'footer': editThemeFooter(resolve.content); break;
                    // case 'form': editThemeApp(resolve.content); break;
                    // case 'input': editThemeApp(resolve.content); break;
                    // case 'tools': editThemeApp(resolve.content); break;
                    // case 'button': editThemeApp(resolve.content); break;
                    // case 'misc': editThemeApp(resolve.content); break;
                }
            }
            else {
...
function closeEditThemes() {
    closeForm('editThemes');
}
